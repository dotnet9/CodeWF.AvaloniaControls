>微信公众号排版工具。问题或建议，请公众号留言。**[Dotnet9](#jump_8)**
...
对于该论述，欢迎读者查阅之前发过的文章，[.NET跨平台框架选择之一 - Avalonia UI](https://mp.weixin.qq.com/s/FqnLGwoT8KgbVTSUii3Q9A)
<a id="jump_8"></a>
### 2.8 图片

插入图片，格式如下：

![这里写图片描述](https://img1.dotnet9.com/site/favicon/wechatpublic.jpg)

支持 jpg、png、gif、svg 等图片格式，**其中 svg 文件仅可在微信公众平台中使用**，svg 文件示例如下：

![](https://img1.dotnet9.com/2026/05/i-am-svg.svg)
