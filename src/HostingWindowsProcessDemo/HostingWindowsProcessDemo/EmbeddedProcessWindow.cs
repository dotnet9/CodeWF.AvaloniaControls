...
namespace HostingWindowsProcessDemo
{
    public class EmbeddedProcessWindow : NativeControlHost
    {
        ...
        private void AttachExternalWindow(VisualTreeAttachmentEventArgs e)
        {
        ...
        private void DetachExternalWindow()
        {
            WinApi.SetParent(ProcessWindowHandle, IntPtr.Zero);
            WinApi.ShowWindow(ProcessWindowHandle, WinApi.SW_HIDE);
        }
    }
}
