...
internal sealed class MarkdownImagePreviewWindow : Window
{
    ...
    public MarkdownImagePreviewWindow(Bitmap bitmap, byte[] imageBytes, string fileName, string? title)
    {
        ...
        _image = CreateBitmapContent(bitmap);
    ...
    private Control CreateLayout()
    {
        ...
        toolbar.Children.Add(CreateButton("1:1", () => SetZoom(1.0)));
        toolbar.Children.Add(CreateButton("适应", FitToWindow));
        toolbar.Children.Add(CreateButton("左旋", () => Rotate(-90)));
        toolbar.Children.Add(CreateButton("右旋", () => Rotate(90)));
    ...
    private void UpdateImageSize()
    {
        ...
        _zoomText.Text = string.Format("{0:P0} / {1} 度", _zoom, _rotation);
    }
